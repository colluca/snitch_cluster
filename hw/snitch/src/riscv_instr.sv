...
package riscv_instr;
  ...
  localparam logic [31:0] SCFGRI             = 32'b????????????00000001?????1011011;
  localparam logic [31:0] SCFGWI             = 32'b?????????????????010000001011011;
  localparam logic [31:0] SCFGR              = 32'b0000000?????00001001?????1011011;
  localparam logic [31:0] SCFGW              = 32'b0000000??????????010000011011011;
  localparam logic [31:0] FLT_D_SSR          = 32'b1010001??????????001?????0101011;
  localparam logic [31:0] FCVT_D_W_SSR       = 32'b110100100000?????????????0101011;
  localparam logic [31:0] FCVT_D_WU_SSR      = 32'b110100100001?????????????0101011;
