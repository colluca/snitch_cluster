...
#define CLUSTER_PERIPH_BASE_ADDR (CLUSTER_TCDM_BASE_ADDR + ${hex(next_power_of_2(cfg['cluster']['tcdm']['size']) * 1024)})
...
#define ALIAS_PERIPH_BASE_ADDR (ALIAS_TCDM_BASE_ADDR + ${hex(next_power_of_2(cfg['cluster']['tcdm']['size']) * 1024)})
