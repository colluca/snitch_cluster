...
add wave -noupdate -expand -group {ring buffer} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/gen_fpu/i_snitch_fp_ss/gen_fpu_sequencer/i_snitch_fpu_sequencer/i_ring_buffer/raddr_i}
...
add wave -noupdate -expand -group {ring buffer} -color Orange {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/gen_fpu/i_snitch_fp_ss/gen_fpu_sequencer/i_snitch_fpu_sequencer/i_ring_buffer/advance_i}
add wave -noupdate -expand -group {ring buffer} -color Orange {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/gen_fpu/i_snitch_fp_ss/gen_fpu_sequencer/i_snitch_fpu_sequencer/i_ring_buffer/step_i}
add wave -noupdate -expand -group {ring buffer} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/gen_fpu/i_snitch_fp_ss/gen_fpu_sequencer/i_snitch_fpu_sequencer/i_ring_buffer/wptr_o}
add wave -noupdate -expand -group {ring buffer} {/tb_bin/i_dut/i_snitch_cluster/i_cluster/gen_core[0]/i_snitch_cc/gen_fpu/i_snitch_fp_ss/gen_fpu_sequencer/i_snitch_fpu_sequencer/i_ring_buffer/rptr_o}
