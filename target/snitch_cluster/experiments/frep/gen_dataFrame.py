...
def read_hardware_configs(file_path):
    """Reads the hardware configuration names from hw_cfg.list file, or asks the user if file is missing."""
...
def collect_results(base_dir, hardware_dirs):
    """Iterates through specified hardware directories, extracts area metrics, and saves them in a CSV."""
